...
import { idlFactory } from './simple_game.did.js';
export { idlFactory } from './simple_game.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SIMPLE_GAME_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./simple_game.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the simple_game canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./simple_game.did.js")._SERVICE>}
 */
export const simple_game = createActor(canisterId);
